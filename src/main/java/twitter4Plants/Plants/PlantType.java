...
public class PlantType {
	...
	public PlantType(int plantTypeId, double temperatureMax,
			double temperatureMin, double temperatureHappy, double humidityMax,
			double humidityMin, double humidityHappy, double lightMax,
			double lightMin, double lightHappy) {
		this.id = plantTypeId;
